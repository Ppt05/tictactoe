...
struct Graphics {
    ...
    SDL_Texture *cellEmpty, *cellX, *cellO, *winX ,*winO, *draw, *X_Turn, *O_Turn,*Step;
    ...
    void init() {
        ...
        O_Turn  = renderText("O_Turn", font, color);
         sfont = loadFont("assets/Purisa-BoldOblique.ttf", 20);
        Step    =renderText("Press ENTER to restart or press ESC to exit ", sfont, {0,0,0,255});
